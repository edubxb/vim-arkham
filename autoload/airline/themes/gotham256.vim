...
let g:airline#themes#arkham256#palette = {}
...
let g:airline#themes#arkham256#palette.normal =
      \ airline#themes#generate_color_map(s:N1, s:N2, s:N3)

" Overrides for when the buffer is modified in normal mode.
let g:airline#themes#arkham256#palette.normal_modified = {
...
if get(g:, 'arkham_airline_emphasised_insert', 1)
  let s:I1 = s:Array('base2', 'yellow')
endif

let g:airline#themes#arkham256#palette.insert =
      \ airline#themes#generate_color_map(s:I1, s:I2, s:I3)

" Overrides for when the buffer is modified in insert mode.
let g:airline#themes#arkham256#palette.insert_modified = {
      \ 'airline_c': s:Array('magenta', 'base1', '')
      \ }

" Overrides for when the paste is toggled in insert mode.
let g:airline#themes#arkham256#palette.insert_paste = {
...
let g:airline#themes#arkham256#palette.replace =
      \ airline#themes#generate_color_map(s:R1, s:R2, s:R3)

" Overrides for when the buffer is modified in normal mode.
let g:airline#themes#arkham256#palette.replace_modified = {
      \ 'airline_c': s:Array('magenta', 'base1', '')
      \ }
...
let g:airline#themes#arkham256#palette.visual =
      \ airline#themes#generate_color_map(s:V1, s:V2, s:V3)

" Overrides for when the buffer is modified.
let g:airline#themes#arkham256#palette.visual_modified =
      \ g:airline#themes#arkham256#palette.normal_modified
...
let g:airline#themes#arkham256#palette.inactive =
      \ airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)

let g:airline#themes#arkham256#palette.inactive_modified = {
...
let g:airline#themes#arkham256#palette.accents = {
      \ 'red': [s:c.red.gui, '', s:c.red.cterm, '']
      \ }

" Terminal =====================================================================

let g:airline#themes#arkham256#palette.terminal =
      \ airline#themes#generate_color_map(s:I1, s:I2, s:I3)
...
let g:airline#themes#arkham256#palette.ctrlp =
