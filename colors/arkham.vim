...
let s:colors.gray    = { 'gui': '#161d24', 'cterm': 8  }
...
call s:Col('CursorLineNr', 'base5', s:background)
...
call s:Col('VertSplit', 'gray', s:background)
call s:Col('StatusLineNC', 'gray', 'gray')
...
call s:Col('StatusLine', 'gray', 'gray')
...
" Spelling.
" SpellBad    gui=undercurl guisp=#C23127 guifg=none guibg=none
" SpellCap    gui=undercurl guisp=#EDB443 guifg=none guibg=none
" SpellLocal  gui=undercurl guisp=#EDB443 guifg=none guibg=none
" SpellRare   gui=undercurl guisp=#C23127 guifg=none guibg=none
